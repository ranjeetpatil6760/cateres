 ...
 <main class="main-content bgc-grey-100">
        <div id="mainContent">
          <div class="container-fluid">
            <h4 class="c-grey-900 mT-10 mB-30">Add Hotel Inventory  item to list</h4>
...
$qry="INSERT INTO hotel_info (date, subtotal, paid, total,status) VALUES ('$date','$stotal','$paid','$total','$st')";
