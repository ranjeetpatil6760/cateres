 ...
 <main class="main-content bgc-grey-100">
        <div id="mainContent">
          <div class="container-fluid">
            <h4 class="c-grey-900 mT-10 mB-30">Worker Details</h4>
            ...
            <div class="bdT bdB">
              <input type="text" class="form-control m-0 bdw-0 pY-15 pX-20"  id="myIn" onkeyup="myFun()" placeholder="Search by Name "></div>
                    ...
                    <a href="add_new_w.php"> <button type="button"  name='but_search' class="btn btn-info add-new"><i class="icon-plus"></i> Add New</button></a>
...
<?php
include "db.php";
$result = mysqli_query($con,"SELECT * FROM h_worker_info order by(w_hid) desc");
